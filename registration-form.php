...
<body>
 ...
 if(empty($gender)) {
   ...
   if(empty($personalweblink)) {
    $personalweblinkErr = "Personal weblink is required";
    $flag = true;
  }
...
<script>
    function isvalid() {
        ...
        if (lastname === "") {
         ...
         if (religion === "") {
            flag = false;
            religionErr.innerHTML ="Religion is required";
        }

         if (presentaddress === "") {
            flag = false;
            presentaddressErr.innerHTML ="Present address is required";
        }

         if (permanentaddress === "") {
            flag = false;
            permanentaddressErr.innerHTML ="Permanent address is required";
        }
         ...
         if (personalweblink === "") {
            flag = false;
            personalweblinkErr.innerHTML ="Personal weblink is required";
        }
